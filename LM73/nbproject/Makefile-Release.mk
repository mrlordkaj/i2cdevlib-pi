...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/liblm73.a

${CND_DISTDIR}/liblm73.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/liblm73.a
	${AR} -rv ${CND_DISTDIR}/liblm73.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/liblm73.a
...
${OBJECTDIR}/LM73.o: LM73.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LM73.o LM73.cpp
