...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libhtu21d.a

${CND_DISTDIR}/libhtu21d.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libhtu21d.a
	${AR} -rv ${CND_DISTDIR}/libhtu21d.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libhtu21d.a
...
${OBJECTDIR}/HTU21D.o: HTU21D.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HTU21D.o HTU21D.cpp
