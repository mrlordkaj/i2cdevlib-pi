...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libL3G4200D.${CND_DLIB_EXT}

${CND_DISTDIR}/libL3G4200D.${CND_DLIB_EXT}: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${LINK.cc} -o ${CND_DISTDIR}/libL3G4200D.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -lwiringPi -lpthread -shared -fPIC
...
${OBJECTDIR}/L3G4200D.o: L3G4200D.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/L3G4200D.o L3G4200D.cpp
