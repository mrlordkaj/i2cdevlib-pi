...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libl3g4200d.a

${CND_DISTDIR}/libl3g4200d.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libl3g4200d.a
	${AR} -rv ${CND_DISTDIR}/libl3g4200d.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libl3g4200d.a
...
${OBJECTDIR}/L3G4200D.o: L3G4200D.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/L3G4200D.o L3G4200D.cpp
