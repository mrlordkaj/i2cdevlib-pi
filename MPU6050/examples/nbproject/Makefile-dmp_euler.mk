...
${OBJECTDIR}/_ext/80f8d31b/Arduino.o: ../../I2Cdev/Arduino.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DOUTPUT_READABLE_EULER -I.. -I../../I2Cdev -include Arduino.h `pkg-config --cflags gdkmm-3.0`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/80f8d31b/Arduino.o ../../I2Cdev/Arduino.cpp
...
${OBJECTDIR}/_ext/5c0/MPU6050.o: ../MPU6050.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DOUTPUT_READABLE_EULER -I.. -I../../I2Cdev -include Arduino.h `pkg-config --cflags gdkmm-3.0`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/MPU6050.o ../MPU6050.cpp

${OBJECTDIR}/Main.o: Main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DOUTPUT_READABLE_EULER -I.. -I../../I2Cdev -include Arduino.h `pkg-config --cflags gdkmm-3.0`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Main.o Main.cpp
