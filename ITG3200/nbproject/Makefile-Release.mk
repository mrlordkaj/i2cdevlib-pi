...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libitg3200.a

${CND_DISTDIR}/libitg3200.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libitg3200.a
	${AR} -rv ${CND_DISTDIR}/libitg3200.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libitg3200.a
...
${OBJECTDIR}/ITG3200.o: ITG3200.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ITG3200.o ITG3200.cpp
