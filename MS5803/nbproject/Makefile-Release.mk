...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libMS5803.${CND_DLIB_EXT}

${CND_DISTDIR}/libMS5803.${CND_DLIB_EXT}: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${LINK.cc} -o ${CND_DISTDIR}/libMS5803.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -lwiringPi -lpthread -shared -fPIC
...
${OBJECTDIR}/MS5803.o: MS5803.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MS5803.o MS5803.cpp
