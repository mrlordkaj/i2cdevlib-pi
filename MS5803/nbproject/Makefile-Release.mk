...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libms5803.a

${CND_DISTDIR}/libms5803.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libms5803.a
	${AR} -rv ${CND_DISTDIR}/libms5803.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libms5803.a
...
${OBJECTDIR}/MS5803.o: MS5803.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MS5803.o MS5803.cpp
