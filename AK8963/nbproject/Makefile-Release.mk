...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libak8963.a

${CND_DISTDIR}/libak8963.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libak8963.a
	${AR} -rv ${CND_DISTDIR}/libak8963.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libak8963.a
...
${OBJECTDIR}/AK8963.o: AK8963.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AK8963.o AK8963.cpp
