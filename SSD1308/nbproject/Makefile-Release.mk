...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libssd1308.a

${CND_DISTDIR}/libssd1308.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libssd1308.a
	${AR} -rv ${CND_DISTDIR}/libssd1308.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libssd1308.a
...
${OBJECTDIR}/SSD1308.o: SSD1308.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SSD1308.o SSD1308.cpp
