...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libbmp085.a

${CND_DISTDIR}/libbmp085.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libbmp085.a
	${AR} -rv ${CND_DISTDIR}/libbmp085.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libbmp085.a
...
${OBJECTDIR}/BMP085.o: BMP085.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BMP085.o BMP085.cpp
