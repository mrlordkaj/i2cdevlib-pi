...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libtca6424a.a

${CND_DISTDIR}/libtca6424a.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libtca6424a.a
	${AR} -rv ${CND_DISTDIR}/libtca6424a.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libtca6424a.a
...
${OBJECTDIR}/TCA6424A.o: TCA6424A.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TCA6424A.o TCA6424A.cpp
