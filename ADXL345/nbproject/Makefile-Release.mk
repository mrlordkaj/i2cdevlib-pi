...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libadxl345.a

${CND_DISTDIR}/libadxl345.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libadxl345.a
	${AR} -rv ${CND_DISTDIR}/libadxl345.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libadxl345.a
...
${OBJECTDIR}/ADXL345.o: ADXL345.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ADXL345.o ADXL345.cpp
