...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libak8975.a

${CND_DISTDIR}/libak8975.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libak8975.a
	${AR} -rv ${CND_DISTDIR}/libak8975.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libak8975.a
...
${OBJECTDIR}/_ext/12601b98/MPU6050.o: ../MPU6050/MPU6050.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/12601b98/MPU6050.o ../MPU6050/MPU6050.cpp

${OBJECTDIR}/AK8975.o: AK8975.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AK8975.o AK8975.cpp
