...
${OBJECTDIR}/_ext/12601b98/MPU6050.o: ../MPU6050/MPU6050.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DDEMO_MPU_RAW -I. -include Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/12601b98/MPU6050.o ../MPU6050/MPU6050.cpp

${OBJECTDIR}/AK8975.o: AK8975.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DDEMO_MPU_RAW -I. -include Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AK8975.o AK8975.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DDEMO_MPU_RAW -I. -include Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
