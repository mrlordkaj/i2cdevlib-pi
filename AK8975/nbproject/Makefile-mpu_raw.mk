...
${OBJECTDIR}/_ext/d28afab9/Arduino.o: ../Arduino/Arduino.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DDEMO_MPU_RAW -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d28afab9/Arduino.o ../Arduino/Arduino.cpp

${OBJECTDIR}/_ext/d28afab9/Wire.o: ../Arduino/Wire.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/d28afab9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DDEMO_MPU_RAW -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d28afab9/Wire.o ../Arduino/Wire.cpp
...
${OBJECTDIR}/_ext/847938aa/I2Cdev.o: ../I2Cdev/I2Cdev.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DDEMO_MPU_RAW -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/847938aa/I2Cdev.o ../I2Cdev/I2Cdev.cpp

${OBJECTDIR}/_ext/12601b98/MPU6050.o: ../MPU6050/MPU6050.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/12601b98
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DDEMO_MPU_RAW -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/12601b98/MPU6050.o ../MPU6050/MPU6050.cpp

${OBJECTDIR}/AK8975.o: AK8975.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DDEMO_MPU_RAW -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AK8975.o AK8975.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DDEMO_MPU_RAW -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
