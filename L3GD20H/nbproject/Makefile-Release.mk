...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libl3gd20h.a

${CND_DISTDIR}/libl3gd20h.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libl3gd20h.a
	${AR} -rv ${CND_DISTDIR}/libl3gd20h.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libl3gd20h.a
...
${OBJECTDIR}/L3GD20H.o: L3GD20H.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/L3GD20H.o L3GD20H.cpp
