...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/liblsm303dlhc.a

${CND_DISTDIR}/liblsm303dlhc.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/liblsm303dlhc.a
	${AR} -rv ${CND_DISTDIR}/liblsm303dlhc.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/liblsm303dlhc.a
...
${OBJECTDIR}/LSM303DLHC.o: LSM303DLHC.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LSM303DLHC.o LSM303DLHC.cpp
