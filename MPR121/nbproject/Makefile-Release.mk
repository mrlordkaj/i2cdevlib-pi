...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libmpr121.a

${CND_DISTDIR}/libmpr121.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libmpr121.a
	${AR} -rv ${CND_DISTDIR}/libmpr121.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libmpr121.a
...
${OBJECTDIR}/MPR121.o: MPR121.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MPR121.o MPR121.cpp
