...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libhmc5843.a

${CND_DISTDIR}/libhmc5843.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libhmc5843.a
	${AR} -rv ${CND_DISTDIR}/libhmc5843.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libhmc5843.a
...
${OBJECTDIR}/HMC5843.o: HMC5843.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HMC5843.o HMC5843.cpp
