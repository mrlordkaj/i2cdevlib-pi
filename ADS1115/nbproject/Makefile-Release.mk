...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libads1115.a

${CND_DISTDIR}/libads1115.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libads1115.a
	${AR} -rv ${CND_DISTDIR}/libads1115.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libads1115.a
...
${OBJECTDIR}/ADS1115.o: ADS1115.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ADS1115.o ADS1115.cpp
