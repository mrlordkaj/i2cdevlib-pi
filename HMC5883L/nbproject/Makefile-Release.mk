...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libhmc5883l.a

${CND_DISTDIR}/libhmc5883l.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libhmc5883l.a
	${AR} -rv ${CND_DISTDIR}/libhmc5883l.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libhmc5883l.a
...
${OBJECTDIR}/HMC5883L.o: HMC5883L.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HMC5883L.o HMC5883L.cpp
