...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libiaq2000.a

${CND_DISTDIR}/libiaq2000.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libiaq2000.a
	${AR} -rv ${CND_DISTDIR}/libiaq2000.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libiaq2000.a
...
${OBJECTDIR}/IAQ2000.o: IAQ2000.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IAQ2000.o IAQ2000.cpp
