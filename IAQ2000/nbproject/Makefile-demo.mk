...
${OBJECTDIR}/_ext/d28afab9/Arduino.o: ../Arduino/Arduino.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DDEMO -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d28afab9/Arduino.o ../Arduino/Arduino.cpp

${OBJECTDIR}/_ext/d28afab9/Wire.o: ../Arduino/Wire.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/d28afab9
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DDEMO -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d28afab9/Wire.o ../Arduino/Wire.cpp
...
${OBJECTDIR}/_ext/847938aa/I2Cdev.o: ../I2Cdev/I2Cdev.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DDEMO -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/847938aa/I2Cdev.o ../I2Cdev/I2Cdev.cpp

${OBJECTDIR}/IAQ2000.o: IAQ2000.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DDEMO -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IAQ2000.o IAQ2000.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DDEMO -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
