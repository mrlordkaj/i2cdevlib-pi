...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/libds1307.a

${CND_DISTDIR}/libds1307.a: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}
	${RM} ${CND_DISTDIR}/libds1307.a
	${AR} -rv ${CND_DISTDIR}/libds1307.a ${OBJECTFILES} 
	$(RANLIB) ${CND_DISTDIR}/libds1307.a
...
${OBJECTDIR}/DS1307.o: DS1307.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DRELEASE -I../Arduino -I../I2Cdev -I. -include ../Arduino/Arduino.h -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DS1307.o DS1307.cpp
